    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
          ...
          <button
            type="submit"
            className="w-full bg-[#B5F285] hover:bg-[#a2e36f] text-black font-semibold py-3.5 rounded-full transition-all cursor-pointer shadow-md text-sm mt-2 active:scale-95"
          >
            Sign Up
          </button>
        </form>
